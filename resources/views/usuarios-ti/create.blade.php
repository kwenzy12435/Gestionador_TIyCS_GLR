  ...
  <form method="POST" action="{{ route('usuarios-ti.store') }}" novalidate>
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input type="text" name="usuario" id="usuario" class="form-control @error('usuario') is-invalid @enderror" value="{{ old('usuario') }}" required>
      ...
      <div class="col-md-6">
        ...
        <input type="password" name="contrasena" id="contrasena" class="form-control @error('contrasena') is-invalid @enderror" required minlength="8">
        <div class="form-text">Mínimo 8 caracteres, con al menos una mayúscula, minúscula y número.</div>
    ...
    <div class="text-end mt-4">
      <button type="submit" class="btn btn-brand"><i class="bi bi-check2 me-1"></i>Guardar Usuario</button>
