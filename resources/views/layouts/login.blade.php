...
<head>
  ...
  <title>@yield('title', 'Iniciar Sesión - Sistema de Gestión TI')</title>
  
  {{-- FAVICON - Usando la misma ruta que en tu layout funcional --}}
...
<body class="auth-page">
    ...
    <div class="auth-bg">
        <video class="auth-video" autoplay muted loop playsinline>
            <source src="{{ asset('Front/VIDEO3.mp4') }}" type="video/mp4">
        </video>
