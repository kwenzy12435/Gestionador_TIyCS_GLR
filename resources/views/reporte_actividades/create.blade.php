    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        ...
        <input type="text" name="actividad" id="actividad"
               ...
               value="{{ old('actividad') }}" required maxlength="255" placeholder="Nombre corto de la actividad">
      ...
      <div class="col-12">
        ...
        <textarea name="descripcion" id="descripcion" rows="4"
                  ...
                  required minlength="10" placeholder="Describe la actividad…">{{ old('descripcion') }}</textarea>
