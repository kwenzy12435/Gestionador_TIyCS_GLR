                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="fw-semibold">{{ Str::limit($reporte->actividad, 50) }}</div>
                                <small class="text-muted">{{ Str::limit($reporte->descripcion, 70) }}</small>
                            </td>
                            <td>
                                @if($reporte->colaborador)
                                    {{ $reporte->colaborador->nombres }} {{ $reporte->colaborador->apellidos }}
                                @else
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form action="{{ route('reporte_actividades.destroy', $reporte->id) }}" 
                                        ...
                                        <button type="submit" class="btn btn-outline-danger" 
                                                onclick="return confirm('¿Eliminar este reporte?')" title="Eliminar">
