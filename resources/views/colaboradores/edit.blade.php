...
<div class="card p-4 shadow-sm">
  <form method="POST" action="{{ route('colaboradores.update', $colaborador) }}" novalidate>
    @csrf
    @method('PUT')
    ...
    <div class="row g-3">
      ...
      <div class="col-md-4">
        ...
        <input type="text" name="usuario" id="usuario"
               ...
               value="{{ old('usuario', $colaborador->usuario) }}" required maxlength="100">
      ...
      <div class="col-md-4">
        ...
        <input type="text" name="nombre" id="nombre"
               ...
               value="{{ old('nombre', $colaborador->nombre) }}" required maxlength="100">
      ...
      <div class="col-md-4">
        ...
        <input type="text" name="apellidos" id="apellidos"
               ...
               value="{{ old('apellidos', $colaborador->apellidos) }}" maxlength="100">
      ...
      <div class="col-md-4">
        ...
        <input type="text" name="puesto" id="puesto"
               ...
               value="{{ old('puesto', $colaborador->puesto) }}" maxlength="100">
      ...
      <div class="col-md-4">
        ...
        <input type="text" name="anydesk_id" id="anydesk_id"
               ...
               value="{{ old('anydesk_id', $colaborador->anydesk_id) }}" maxlength="50">
        @error('anydesk_id') <div class="invalid-feedback">{{ $message }}</div> @enderror
      </div>
    </div>
