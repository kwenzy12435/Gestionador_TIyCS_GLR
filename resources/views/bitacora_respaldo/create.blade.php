...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('bitacora_respaldo.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('fecha_respaldo') is-invalid @enderror" 
                                       id="fecha_respaldo" name="fecha_respaldo" value="{{ old('fecha_respaldo') }}" required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('ubicacion_guardado') is-invalid @enderror" 
                                       id="ubicacion_guardado" name="ubicacion_guardado" value="{{ old('ubicacion_guardado') }}">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('acciones_alternativas') is-invalid @enderror" 
                                          id="acciones_alternativas" name="acciones_alternativas" rows="3">{{ old('acciones_alternativas') }}</textarea>
