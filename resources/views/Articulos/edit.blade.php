...
@section('page-header')
<h1 class="h3 mb-0 fw-bold"><i class="bi bi-pencil-square me-2"></i>Editar artículo</h1>
@endsection
        ...
        <div class="row g-3">
                ...
                <select name="subcategoria_id" id="subcategoria_id" class="form-select @error('subcategoria_id') is-invalid @enderror">
                    ...
                    @foreach($subcategorias as $subcategoria)
                        <option value="{{ $subcategoria->id }}" 
                            ...
                            {{ old('subcategoria_id', $articulo->subcategoria_id) == $subcategoria->id ? 'selected' : '' }}>
                            {{ $subcategoria->nombre }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-12">
                ...
                <textarea name="descripcion" id="descripcion" 
                          ...
                          rows="3">{{ old('descripcion', $articulo->descripcion) }}</textarea>
                @error('descripcion')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
